...
This uses an in‑memory SQLite database and covers the health check and quote calculation flow.
...
- Fill the multi‑step quote form with realistic values (e.g. year, make, model, mileage, zip)
...
- **Screenshots / GIFs**
  ...
  - Frontend multi‑step quote form:

    ![AutoFlow Frontend Wizard](./docs/frontend.png)

  - Backend API documentation (Swagger):

    ![AutoFlow API Docs](./docs/backend-swagger.png)
```